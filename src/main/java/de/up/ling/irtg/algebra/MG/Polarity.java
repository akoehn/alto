...
public class Polarity {
    ...
    private int intValue; // +1,-1 so that all negative licensing features have the same name
    ...
    /**
     * Class constructor for overt move or selectional features
     * @param value 
     * @param set
     * @param intValue 
     */
    ...
    public String toString(Boolean verbose) {
        if (verbose) {
            return "value: " + name + ",set: " + set + ", integer value: " + intValue;
        } else {return name;}
    }
}
